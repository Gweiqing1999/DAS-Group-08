...
```{r scatp, echo=FALSE, warning=FALSE, out.width='70%', fig.align = "center", fig.cap = "\\label{fig:scatp} Scatterplot matrix of the numerical variables.", fig.pos = "H"}
...
```{r boxp, echo=FALSE, out.width='70%', fig.align = "center", fig.cap = "\\label{fig:boxp1} Boxplot of rating by genre.", fig.pos = "H"}
...
```{r col, echo=FALSE, warning=FALSE, fig.width = 10, fig.align = "center", fig.cap = "\\label{fig:col} Genres of IMDB Rated Films and their rating status.", fig.pos = "H"}
...
```{r boxpl, echo=FALSE, warning=FALSE, fig.width = 10, fig.align = "center", fig.cap = "\\label{fig:boxp2} Proportions of Yes/No Ratings by Genre.",fig.pos = "H"}
...
```{r, echo=FALSE, warning=FALSE, out.width = "87.5%", fig.width = 10, fig.height = 4, dpi = 150, fig.align = "left", fig.cap = "\\label{fig:modp1} Log-Odds (Rating above 7).", fig.pos = "H"}
...
```{r, echo=FALSE, warning=FALSE, out.width = "87.5%", fig.width = 10, fig.height = 4, dpi = 150, fig.align = "left", fig.cap = "\\label{fig:modp2} Odds (Rating above 7).", fig.pos = "H"}
...
```{r, echo=FALSE, warning=FALSE, out.width = "87.5%", fig.width = 10, fig.height = 4, dpi = 150, fig.align = "left", fig.cap = "\\label{fig:modp3} Estimated probability of ranting being above 7 by genre.", fig.pos = "H"}
plot_model(model.genre, type = "pred", title = "",
           axis.title = c("Genre", "Prob. of ranting being above 7"))
```

```{r, echo=FALSE, fig.width = 10, fig.align = "center", fig.cap = "\\label{fig:boxp3} Frequencies and estimated probabilities by Genre.", fig.pos = "H"}
# Probability
...
```{r, echo=FALSE, warning=FALSE, out.width = "87.5%", fig.width = 10, fig.height = 4, dpi = 150, fig.align = "left", fig.cap = "\\label{fig:modp4} Log-Odds (Rating above 7) for the step model.", fig.pos = "H"}
...
```{r, echo=FALSE, warning=FALSE, out.width = "87.5%", fig.width = 10, fig.height = 4, dpi = 150, fig.align = "left", fig.cap = "\\label{fig:modp5} Odds (Rating above 7) for the step model.", fig.pos = "H"}
